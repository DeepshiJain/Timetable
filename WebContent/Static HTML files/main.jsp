	...
	<body>
		...
		<div id="main_container">
			...
			<div id="redips-drag">
				...
				<!-- right container -->
				<div id="right">
					<table id="table2"  class="table table-striped" width="900" style="position:absolute;margin-left:250px;">
						<colgroup>
							<col width="550"/>
							<col width="500"/>
							<col width="500"/>
						...
						<tbody>
							<tr class="danger">
								...
								<td style="width: 300px;" class="redips-mark dark" >8-9</td>
								<td style="width: 300px;" class="redips-mark dark" >9-10</td>
								<td style="width: 300px;" class="redips-mark dark" >10-11</td>
								<td style="width: 300px;" class="redips-mark dark" >11-12</td>
								<td style="width: 300px;" class="redips-mark dark" >12-1</td>	
								<td style="width: 300px;" class="redips-mark dark" >1-2</td>
								<td style="width: 300px;" class="redips-mark dark" >2-3</td>
								<td style="width: 300px;" class="redips-mark dark" >3-4</td>
								<td style="width: 300px;" class="redips-mark dark" >4-5</td>
			...
			<div id="message" style="position:absolute;margin-top:500px;margin-left:450px;">Drag subjects to the timetable (clone subjects with SHIFT key)</div>
		</div><!-- main container -->
	</body>
</html>
